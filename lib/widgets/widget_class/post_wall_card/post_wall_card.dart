...
class PostWallCard extends StatelessWidget {
  const PostWallCard({super.key});
      ...
      child: Column(
        children: [
          Row(
            children: [
              ClipRRect(
                child: Image.asset('assets/images/img_one.jpg', width: 50, height: 50),
          ...
          Row(
            ...
            children: [
              Text("category", style: smallBlack),
              Container(
